...
%  first load and visualize the dataset that contains handwritten digits.
%
...
%  Now, we will be starting to implment a two layer neural network that
%  classifies digits. First, we will be implementing a function to initialize 
...
%  Now, we should proceed to implement the backpropagation algorithm for the 
%  neural network; to return the partial derivatives of the parameters.
%
...
%  Once our backpropagation implementation is correct, now we must
